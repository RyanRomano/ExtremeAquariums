package v2;
/**
 * Fresh water fish subclass of Fish
 * contains all properties that fresh water fish have
 */
public class FreshwaterFish extends Fish {
         ...
         * @return freshWater - if true fish belongs in fresh water
         */
         ...
         * @param freshWater - if true fish belongs in fresh water
         */
